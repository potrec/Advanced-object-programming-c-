...
void zad1()
{
    ...
    catalog.addCar(2,Car("Mercedes", "Amg", 2011, "JH4KA7654LC000002"));
    catalog.addCar(3,Car("Fiat", "126p", 1980, "JH4KA7654LC000003"));
    catalog.addCar(4,Car("Seat", "Leon", 2013, "JH4KA7654LC000004"));
    catalog.addCar(5,Car("Ferrari", "Enzo", 2014, "JH4KA7654LC000005"));
...
void zad3(){
    ...
    cout<<"Wyswietlenie krajow w podanym zasiegu"<<std::endl;
...
int main(int argc, char *argv[])
{
    ...
    zad2("The quick brown fox jumps over the lazy dog");
